...
class MQTTWorker {
    ...
    createSendTransfer(topic, data) {
        const packets = mqtt_utils_1.createFixedDataPacket(new Buffer(data), this.max_packet_size);
    ...
    topic_acktest(payload) {
        ...
        if (ack) {
            ...
            if (ack.readUInt16LE(0) === 0xFFFF) {
                ...
                const data = mqtt_utils_1.createFixedDataPacket(new Buffer(test_str.repeat(6)), 8);
